    ...
    <main className="flex flex-1 flex-col items-center px-4 py-10 sm:py-16">
      <div className="w-full max-w-md">
        ...
        <div className="mt-3 rounded-3xl bg-gradient-to-br from-amber-600 to-orange-500 p-6 text-white shadow-lg">
          <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">⇕ Đồng nghĩa · trái nghĩa</h1>
          <p className="mt-2 text-sm text-white/90">
            Thử nghiệm: 1 cụm từ gần nghĩa đối đầu trực tiếp với 1 cụm từ trái nghĩa — không cần chung
            chữ Hán.
          </p>
        </div>
