...
const LANG_LABEL: Record<string, string> = {
  zh: "Nối đuôi tiếng Trung",
  ja: "Nối đuôi tiếng Nhật",
  ko: "Nối đuôi tiếng Hàn",
};
    ...
    <main className="flex flex-1 flex-col items-center px-4 py-10 sm:py-16">
      <div className="w-full max-w-md">
        ...
        <div className="mt-3 rounded-3xl bg-gradient-to-br from-amber-600 to-orange-500 p-6 text-white shadow-lg">
          <h1 className="text-2xl font-bold tracking-tight sm:text-3xl">🔗 Nối đuôi</h1>
          <p className="mt-2 text-sm text-white/90">
            Thử nghiệm: domino từ vựng theo chữ Hán dùng chung — chữ ĐUÔI của từ trước trùng chữ ĐẦU
            của từ sau, nối dài thành 1 chuỗi trực quan.
          </p>
        </div>
